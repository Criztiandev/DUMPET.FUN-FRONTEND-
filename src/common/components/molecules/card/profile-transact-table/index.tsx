...
export const columns: ColumnDef<MarketProfile>[] = [
  {
    accessorKey: "Title",
    header: ({ column }) => {
      return (
  ...
  {
    accessorKey: "MarketProcessId",
    header: "Market Process ID",
    cell: ({ row }) => <div>{row.getValue("MarketProcessId")}</div>,
  },
  {
    id: "actions",
    enableHiding: false,
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() =>
                navigator.clipboard.writeText(profile.MarketProcessId)
              }
            >
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem
              onClick={() => navigate(`/market/${profile.MarketProcessId}`)}
            >
              View Details
            </DropdownMenuItem>
          </DropdownMenuContent>
